...
public extension UIImage {
    ...
    //UIFont.appFont(forTextStyle: .title1)
    class func imageSnap(text: String?, font:UIFont, color: UIColor, textColor: UIColor = .white, bounds: CGRect, contentMode: UIView.ContentMode = .scaleToFill) -> UIImage? {
    ...
    static func sharedImage(named: String) -> UIImage? {
        return UIImage.init(named: named, in: Bundle(for: Self.self), compatibleWith: nil)
    }
