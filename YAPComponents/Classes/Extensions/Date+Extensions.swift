...
extension Date {
    ...
    public var transactionSectionReadableDate: String {
    ...
    public var transactionDetailsReadableDate: String {
        let dateFormatter = DateFormatter()
    ...
    public var transactonNoteUserReadableDateString: String {
    ...
    public var refferalTimeString: String  {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ss"
        return dateFormatter.string(from: self)
    }
    
    public var leanPlumDateAndTimeString: String {
        let dateFormatter = DateFormatter()
    ...
    public var leanPlumDateString: String {
        let dateFormatter = DateFormatter()
        dateFormatter.timeZone = TimeZone(abbreviation: "GST")
    ...
    public var householdServerDateString: String {
        let dateFormatter = DateFormatter()
        dateFormatter.timeZone = TimeZone(abbreviation: "GST")
        dateFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ss"
        return dateFormatter.string(from: self)
    ...
    public func localizedStringOfDate() -> String {
        let dateFormatter = DateFormatter()
