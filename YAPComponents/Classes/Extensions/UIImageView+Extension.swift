...
//  YAPKit
//
//  Created by Hussaan S on 03/07/2019.
...
extension UIImageView {
    ...
    open func setImage(string: String = "", color: UIColor = .white, textColor: UIColor = .white, bounds: CGRect) {

        let image = UIImage.imageSnap(text: string.isEmpty ? "" : string.initials, color: color, bounds: bounds, contentMode: contentMode)
