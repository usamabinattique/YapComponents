 ...
 */
@IBDesignable
public class AppRoundedButton: UIButton {
...
//                self.alpha = self.isEnabled ? 1 : 0.3
                self.backgroundColor = self.isEnabled ? UIColor.primary : UIColor.greyLight
    ...
    public var iconPosition: AppRoundedButtonIconPosition = .right {
        didSet {
            positionIcon()
        }
    }
