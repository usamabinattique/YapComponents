//
//  PeekCollectionViewDelegate.swift
//  YAPKit
//
...
@objc public protocol PeekCollectionViewDelegate: AnyObject {
    ///Will be called when the current active index has changed
    @objc optional func peekImplementation(_ peekImplementation: PeekCollectionViewDelegateImplementation, didChangeActiveIndexTo activeIndex: Int)
    ///Will be called when the user taps on a cell at a specific index path
    @objc optional func peekImplementation(_ peekImplementation: PeekCollectionViewDelegateImplementation, didSelectItemAt indexPath: IndexPath)
}

open class PeekCollectionViewDelegateImplementation: NSObject {
    ...
    public weak var delegate: PeekCollectionViewDelegate?
    ...
    public init(cellSpacing: CGFloat = 15, cellPeekWidth: CGFloat = 20, scrollThreshold: CGFloat = 50, minimumItemsToScroll: Int = 1, maximumItemsToScroll: Int = 1, numberOfItemsToShow: Int = 1, scrollDirection: UICollectionView.ScrollDirection = .horizontal) {
...
extension PeekCollectionViewDelegateImplementation: UICollectionViewDelegateFlowLayout {
