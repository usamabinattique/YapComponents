...
class SearchableActionSheetViewController: UIViewController {
    ...
    init(_ viewModel: SearchableActionSheetViewModelType) {
...
private extension SearchableActionSheetViewController {
    func setupViews() {
        ...
        tableView.register(SearchableActionSheetTableViewCell.self, forCellReuseIdentifier: SearchableActionSheetTableViewCell.reuseIdentifier)
    }
