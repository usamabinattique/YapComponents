...
//  YAPKit
//
//  Created by Janbaz Ali on 24/11/2020.
...
public class FloatingButton: NSObject {
    ...
    private lazy var badge: PaddedLabel = UILabelFactory.createUILabel(with: .white, textStyle: .regular, alignment: .center, numberOfLines: 1, lineBreakMode: .byWordWrapping)
    ...
    private lazy var imageView: UIImageView = UIImageViewFactory.createImageView(mode: .scaleAspectFit, image: UIImage.init(named: "icon_floating_chat", in: yapKitBundle, compatibleWith: nil))
