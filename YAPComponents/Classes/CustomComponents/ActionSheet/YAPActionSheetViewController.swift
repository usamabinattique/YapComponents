...
class YAPActionSheetViewController: UIViewController {
    ...
    private lazy var subTitleLabel: UILabel = UILabelFactory.createUILabel(with: .greyDark, textStyle: .small, numberOfLines: 0)
    
    private lazy var titleStack = UIStackViewFactory.createStackView(with: .vertical, alignment: .leading, distribution: .fill, spacing: 5, arrangedSubviews: [titleLabel, subTitleLabel])
    ...
    init(viewModel: YAPActionSheetViewModelType) {
...
private extension YAPActionSheetViewController {
    func setupViews() {
        ...
        tableView.register(YAPActionSheetTableViewCell.self, forCellReuseIdentifier: YAPActionSheetTableViewCell.reuseIdentifier)
        tableView.register(YAPActionSheetBigIconTableViewCell.self, forCellReuseIdentifier: YAPActionSheetBigIconTableViewCell.reuseIdentifier)
    }
