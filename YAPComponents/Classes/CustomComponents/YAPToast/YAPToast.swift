...
public class YAPToast: NSObject {
    ...
    private lazy var toast: PaddedLabel = UILabelFactory.createUILabel(with: .white, textStyle: .micro, alignment: .center, numberOfLines: 0, lineBreakMode: .byWordWrapping)
