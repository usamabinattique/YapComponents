...
public class YAPAlertView: NSObject {
    ...
    public init(icon: UIImage?, text: NSAttributedString, primaryButtonTitle: String, cancelButtonTitle: String?) {
        viewModel = YAPAlertViewModel(icon: icon, text: text, primaryActionTitle: primaryButtonTitle, cancelTitle: cancelButtonTitle)
        viewController = YAPAlertViewController(viewModel: viewModel)
