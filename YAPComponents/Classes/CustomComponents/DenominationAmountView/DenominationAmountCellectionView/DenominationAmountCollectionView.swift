...
open class DenominationAmountCollectionView: UIView {
    ...
    private func registerCell() {
        collectionView.register(DenominationAmountCollectionViewCell.self, forCellWithReuseIdentifier: DenominationAmountCollectionViewCell.reuseIdentifier)
    }
    
    private func bind() {
        viewModelItems.bind(to: collectionView.rx.items(cellIdentifier: DenominationAmountCollectionViewCell.reuseIdentifier, cellType: DenominationAmountCollectionViewCell.self)) {[unowned self] _, data, cell in
