...
//  YAPKit
//
//  Created by Muhammad Hassan on 26/08/2019.
...
public class BarGraphView: UIView {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(BarGraphCollectionViewCell.self, forCellWithReuseIdentifier: BarGraphCollectionViewCell.reuseIdentifier)
    ...
    lazy var monthLabel: UILabel = UILabelFactory.createUILabel(with: .greyDark, textStyle: .small, alignment: .center)
    ...
    private func bind() {
        dataSubject
            ...
            .bind(to: collectionView.rx.items) { [weak self] collectionView, item, transaction in
                ...
                let cell = collectionView.dequeueReusableCell(withReuseIdentifier: BarGraphCollectionViewCell.reuseIdentifier, for: IndexPath(item: item, section: 0)) as! BarGraphCollectionViewCell
...
public extension Reactive where Base: BarGraphView {
