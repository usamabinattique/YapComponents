...
public class RecentBeneficiaryView: UIView, ConfigurableView {
    ...
    private lazy var leftLabel = UILabelFactory.createUILabel(with: .greyDark, textStyle: .micro, alignment: .left)
    
    private lazy var showButton = UIButtonFactory.createButton(title: "Show recent transfers", backgroundColor: .clear, textColor: .primary)
    
    private lazy var hideButton = UIButtonFactory.createButton(title: "Hide", backgroundColor: .clear, textColor: .primary)
    ...
    private lazy var saperator: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor.greyDark.withAlphaComponent(0.15)
...
private extension RecentBeneficiaryView {
    func setupViews() {
        ...
        collectionView.register(RecentBeneficiaryCollectionViewCell.self, forCellWithReuseIdentifier: RecentBeneficiaryCollectionViewCell.reuseIdentifier)
...
public protocol RecentBeneficiaryViewLayoutDelegate: class {
