...
class RecentBeneficiaryCollectionViewCell: RxUICollectionViewCell {
    ...
    private lazy var flag = UIImageViewFactory.createBackgroundImageView(mode: .scaleAspectFit)
    ...
    private lazy var packageIndicator = UIImageViewFactory.createBackgroundImageView(mode: .scaleAspectFit)
    
    private lazy var nameLabel = UILabelFactory.createUILabel(with: .greyDark, textStyle: .micro, alignment: .center, numberOfLines: 2, lineBreakMode: .byTruncatingTail)
