...
//    open var onTap: ((_ sender: UIVerticalButton) -> Void)?
    ...
    public lazy var titleLable: UILabel =  UIFactory.makeLabel(alignment: .center) //UILabelFactory.createUILabel(with: .primary, textStyle: .micro, alignment: .center)
    public lazy var iconImageView: UIImageView = UIFactory.makeImageView() //UIImageViewFactory.createImageView(mode: .scaleAspectFit)
