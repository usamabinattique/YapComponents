...
public struct Account: Codable {
    ...
    private let _applicationStatus: String?
    private let _applicationSubStatus: String?
    public var applicationStatus: ApplicationStatus {   ApplicationStatus(rawValue: _applicationStatus ?? "") ??  ApplicationStatus.unknown }
    public var applicationSubStatus: ApplicationSubStatus {   ApplicationSubStatus(rawValue: _applicationSubStatus ?? "") ?? ApplicationSubStatus.unknown}
    public var accountStatus: AccountStatus { AccountStatus(rawValue: _accountStatus ?? "") ?? AccountStatus.unknown }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case _applicationStatus = "applicationStatus"
        case _applicationSubStatus = "applicationSubStatus"
...
public extension Account {
    init(account: Account, updatedMobileNumber: String) {
        ...
        self._applicationStatus = account._applicationStatus
        self._applicationSubStatus = account._applicationSubStatus
    }
...
public extension Account {
    static var mocked: Account {
        return Account.init(uuid: "12312321", iban: "AE545646464646", accountNumber: "1000000212120", accountType: .b2cAccount, defaultProfile: true, companyName: nil, packageName: nil, status: "Active", active: true, documentsVerified: true, companyType: nil, soleProprietary: true, _applicationStatus: nil, _applicationSubStatus: nil, _accountStatus: AccountStatus.onboarded.rawValue, customer: Customer(uuid: "12312321", _email: "email@domain.com", countryCode: "", mobileNo: "213123123", firstName: "Aftab", lastName: "Iqbal", companyName: nil, emailVerified: true, mobileNoVerified: true, status: "Active", dob: "", passportNo: nil, nationality: nil, imageURL: nil, customerId: nil, homeCountry: nil, founder: false, customerColor: nil), bank: Bank(id: 1, name: "UBL", bankCode: "1234", swiftCode: "1234", address: "Iris Watson P.O. Box 283 8562 Fusce Rd. Frederick Nebraska 20620 (372) 587-2335"), _parnterBankStatus: PartnerBankStatus.activated.rawValue, createdDate: "2019-08-07T12:15:47", parentAccount: nil, otpBlocked: nil, _eidExpiryStatus: nil, eidNotificationContent: nil, _freezeCode: nil, _freezeInitiator: nil, _partnerBankApprovalDate: nil, qrCodeId: nil, documentSubmissionDate: nil)
    }
}
...
public enum AccountStatus: String, Codable {
    case eidPending = "EID_PENDING"
    case eidCaptured = "CAPTURED_EID"
    case tradeLicensePending = "TRADE_LICENSE_PENDING"
    case tradeLicenseCaptured = "CAPTURED_TRADE_LICENSE"
    case addressCaptured = "ADDRESS_CAPTURED"
    case partnerDetailsPending = "PARTNER_DETAIL_PENDING"
...
public enum ApplicationSubStatus: String, Codable {
    case signUpInProgress = "SIGN_UP_IN_PROCESS"
    case infoCollected = "INFO_COLLECTED"
    case eidCheckCompleted = "EID_CHECK_COMPLETED"
    case tradeLicenseCheckCompleted = "TRADE_LICENSE_CHECK_COMPLETED"
    case tradeLicenseValidationCompleted = "TRADE_LICENSE_VALIDATION_COMPLETED"
    case govermentScreeningCompleted = "CBUAE_SCREENING_COMPLETED"
    case globalScreeningCompleted = "WORLD_CHECK_SCREENING_COMPLETED"
    case meetingDetailsSet = "MEETING_DETAILS_SET"
    case companyDocumentsUploaded = "COMPANY_DOCUMENTS_UPLOADED"
    case cddInformationCompleted = "CDD_INFORMATION_COMPLETED"
    case shareholdersInformationCompleted = "SHAREHOLDERS_INFORMATION_COMPLETED"
    case shareholdersGovermentScreeningCompleted = "SHAREHOLDERS_CBUAE_SCREENING COMPLETED"
    case shareholdersGlobalScreeningCompleted = "SHAREHOLDERS_WORLD_CHECK_SCREENING_COMPLETED"
    case signatoriesInformationCompleted  = "SIGNATORIES_INFORMATION_COMPLETED"
    case riskScoreCompleted = "RISK_SCORE_COMPLETED"
    case customerAccountCompleted = "CUSTOMER_DUE_DILIGENCE_DONE"
    case unknown = ""
}

public enum ApplicationStatus: String, Codable {
