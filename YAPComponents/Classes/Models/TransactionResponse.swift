...
public struct TransactionResponse: Codable, Transaction {
    ...
    public let transactionNoteDate: Date?
    public let card: String?
    public var id: Int
    public let productName: String?
    public let _productCode: String?
    ...
    public let otherBankName: String?
    public let otherBankCurrency: String?
    public let otherBankCountry: String?
    public let otherBankBIC: String?
    public let otherBankBranch: String?
    public let fxRate: String?
    public let settlementAmount: Double
    public var index: Int?
    public var customerId: String?
    public var remarks: String?
    public var receiverTransactionNote: String?
    public let receiverTransactionNoteDate: Date?
    public let cardName1: String?
    public let cardName2: String?
    public let markupFee: Double?
    public let cardHolderBillingAmount: Double
    public let virtualCardDesignCode: CardDesign?
    private var _txnState: String?
    public let beneficiaryId: String?
    public let senderCustomerId: String?
    public var transactionState: TransactionState? { TransactionState(rawValue: _txnState ?? "") ?? .unknown }
    public var cardHolderBillingCurrency: String?
    public var cardHolderBillingTotalAmount: Double
    public let tapixCategory: TapixTransactionCategory?
    
    public var sectionDate: Date {
        return date.startOfDay
    }

    public var type: TransactionType { TransactionType(rawValue: _type ?? "") ?? .unknown }

    public var productCode: TransactionProductCode { TransactionProductCode(rawValue: _productCode ?? "") ?? .unknown }
    ...
    public static let loadingId = "LOADINGTRANSACTIONS"

    public static var loadingValue: TransactionResponse {
...
public extension Array where Element == TransactionResponse {
    var indexed: [Element] {
