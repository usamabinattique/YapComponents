...
public struct TapixTransactionCategory: Codable {
    public let id: Int
...
public extension TapixTransactionCategory {
...
extension TapixTransactionCategory: Equatable {
    public static func == (lhs: TapixTransactionCategory, rhs: TapixTransactionCategory) -> Bool {
        lhs.name == rhs.name
    }
}
